    ...
    switch (result){
      case 0 :
        if(userData.getAdminStatus()){
          print('Kamalud');
          print('Dewi Persik');
          Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => RamayanaProfile() ), (Route<dynamic> route) => false);
          print('Masuk ke sini Profil');
        }else{
          print('Steven William');
          Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => RamayanaHome() ), (Route<dynamic> route) => false);
